...
- (NSURL *)applicationFilesDirectory
{
    ...
    return [appSupportURL URLByAppendingPathComponent:@"net.lovelyhead.SayDo"];
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"SayDo" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *url = [applicationFilesDirectory URLByAppendingPathComponent:@"SayDo.storedata"];
